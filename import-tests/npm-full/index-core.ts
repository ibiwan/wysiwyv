...
// this is a value error because there is no $int plugin
if (result.errors[0]?.message !== "Value: Expected '$int', got '123'") {
  throw "result.errors[0].message Should describe a Value error";
}
